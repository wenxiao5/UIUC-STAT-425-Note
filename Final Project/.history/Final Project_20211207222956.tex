...
1. Constancy of Variance (Homoscedasticity): By the Residuals vs. Fitted plot (scatter uniformly) and studentized Breusch-Pagan test result (p-value=0.117>0.05), we can conclude homoscedasticity assumption holds in the additive model. \\
\begin{figure}[htb]
    \centering
