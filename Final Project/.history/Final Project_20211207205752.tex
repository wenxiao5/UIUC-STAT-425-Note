...
We first plot the Interaction Plots (Figure 1) and then use the F-test to test the interaction term's significance.
...
We find the interaction is presented in the plot. However, the p-value (0.68293) of the F-test is higher than 0.05, which means the interaction term is statistically insignificant.
\begin{center}\begin{figure}[htb]
    \centering
