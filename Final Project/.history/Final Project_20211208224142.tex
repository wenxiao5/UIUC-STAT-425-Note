...
\subsection{Summary}
\subsection{Conclusion (layman)}
According to the project, we think there are no combination effect of line speed and percent loading of additives, so the optimal combination is the optimal line speed with the optimal percent loading of additives. We find that the compared to 36 and 38, 37 is the best line speed that can increase most production rate. And 4\% is optimal percent loading of additives increase production most compared to 0\% and 2\%. All in all we can conclude that the optimal combination is \textbf{$37$ Line Speed} and \textbf{$4\%$ Percent Loading of Additives}.
