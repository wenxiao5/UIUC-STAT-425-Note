...
We find the interaction is presented in the plot. However, the p-value (0.68293) of the F-test is higher than 0.05, which means the interaction term is statistically insignificant. Then 
\begin{center}\begin{figure}[htb]
    \centering
    \includegraphics[scale=0.8]{inter2.png}
    \caption{ANOVA partial F-test Results about interaction term}
    \label{}
\end{figure}\end{center}
