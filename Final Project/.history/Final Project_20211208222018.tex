...
We first plot the Interaction Plots (\ref{Figure 1}) and then use the partial F-test of ANOVA table (\ref{Figure 2}) to test the interaction term's significance.\\
