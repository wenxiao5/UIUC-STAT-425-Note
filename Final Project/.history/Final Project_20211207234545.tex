...
1. \textbf{Line Speed}: According to the Tukey’s paired comparison results, the 95\% family-wise confidence level of \textit{effect of 37 Line Speed}-\textit{effect of 37 Line Speed}
