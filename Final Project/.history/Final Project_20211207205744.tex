...
We find the interaction is presented in the plot. However, the p-value (0.68293) of F-test is higher than 0.05, which means the interaction term is statistically insignificant.
\begin{center}\begin{figure}[htb]
    \centering
