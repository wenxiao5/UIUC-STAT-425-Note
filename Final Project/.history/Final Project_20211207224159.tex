...
The normality assumption doesn't hold in the additive model. Because our response variable contains only positive values, Box-Cox transformation is a possible remedy to violations of assumptions.
