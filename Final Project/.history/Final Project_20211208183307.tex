...
These mean \textit{Effect of 2\% Percent Loading of Additives} and \textit{Effect of 0\% Percent Loading of Additives} are statistically the same; \textit{Effect of 4\% Percent Loading of Additives}  is statistically larger than \textit{Effect of 0\% Percent Loading of Additives}; \textit{Effect of 4\% Percent Loading of Additives} is statistically larger than \textit{Effect of 2\% Percent Loading of Additives}.\\
