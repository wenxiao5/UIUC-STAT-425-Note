...
The Box-cox transformation can't fix the normality violation problem. However, the new additive model has higher Adjusted R-squared (Adjusted $R^2=0.5604$, Figure 14) than previous additive model (Adjusted $R^2=0.3258$, Figure 15). So, we are better to use the new additive model to 
\begin{figure}[htb]
    \centering
