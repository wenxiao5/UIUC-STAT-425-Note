...
In the additive model, the normality assumption is violated. Because our response variable only contains positive values, the Box-Cox transformation may be used to address assumptions violations.
