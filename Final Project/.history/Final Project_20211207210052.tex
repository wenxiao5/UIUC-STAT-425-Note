...
We first plot the Interaction Plots (Figure 1) and then use the F-test (Figure 2) to test the interaction term's significance.
...
\begin{center}\begin{figure}[htb]
    ...
    \caption{F-test Results about interaction term}
    \label{}
\end{figure}\end{center}
