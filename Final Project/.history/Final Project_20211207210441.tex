...
$i=36,37,38;\ j=0\%,2\%,4\%;\ k=1,2,3$\\

We first plot the Interaction Plots (Figure 1) and then use the partial F-test (Figure 2) to test the interaction term's significance.
...
We find the interaction is presented in the plot. However, the p-value (0.68293) of the F-test is higher than 0.05, which means the interaction term is statistically insignificant. Then we remove the interaction term.
\begin{center}\begin{figure}[htb]
    \centering
    \includegraphics[scale=0.8]{inter2.png}
    \caption{ANOVA Table: Partial F-test Results}
    \label{}
\end{figure}\end{center}
