...
The objective of this project is to determine the best operating
conditions for the Company XX's bubble wrap lines to increase production capacity. We analyze the results of a complete randomized design was implemented with two most significant factors.

the engineers
decided that line speed, and percent loading of additives were the most signi cant fac-
tors and thus a complete randomized (also called factorial) design was implemented with these
two factors:
