...
In order to check the assumptions, we run the studentized Breusch-Pagan
test (Figure 4), Kolmogorov-Smirnov test (Figure 5) and plot the diagnostic plots (Figure 6) which includes 1. Residuals vs. Fitted plot; 2. Normal Q-Q plot.\\
1. Constancy of Variance (Homoscedasticity): By the Residuals vs. Fitted plot and . \\
\begin{figure}[htb]
    \centering
    \includegraphics[scale=0.3]{BP1}
    \caption{}
    \label{}
\end{figure}
\begin{figure}[htb]
    \centering
    \includegraphics[scale=0.3]{KS1}
    \caption{}
    \label{}
\end{figure}
\begin{figure}[htb]
