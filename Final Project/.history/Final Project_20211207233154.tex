...
The Box-cox transformation can't fix the normality violation problem. However, the new additive model has higher Adjusted R-squared (Adjusted $R^2=0.5604$) than previous additive model (Adjusted $R^2=0.5604$)
