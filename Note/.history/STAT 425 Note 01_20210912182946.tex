...
(3)$$Var(\mathbf{A}\mathbf{Z})=\mathbb{E}[(\mathbf{A}\mathbf{Z}-\mathbf{A}\mu)(\mathbf{A}\mathbf{Z}-\mathbf{A}\mu)]=\mathbf{A}\mathbb{E}[(\mathbf{Z}-\mu)(\mathbf{A}\mathbf{Z}-\mathbf{A}\mu)]$$
