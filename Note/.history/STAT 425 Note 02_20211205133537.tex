...
\hline Treatments & $S S_{\text {Treatments }}$ & $a-1$ & $\frac{S S_{\text {Treatments }}}{a-1}$ & $\frac{M S_{\text {Treatments }}}{M S_{g}}$ \\
\hline Blocks & $S S_{\text {Blocks }}$ & $b-1$ & $\frac{S S_{\text {Blocks }}}{b-1}$ & \\
\hline Error & $S S_{E}$ & $(a-1)(b-1)$ & $\frac{S S_{g}}{(a-1)(b-1)}$ & \\
\hline Total & $S S_{T}$ & $ab-1$ & & \\
\hline
\end{tabular}
...
$\begin{array}{lcc}\text { AOV } & d f & d f \text { for the example } \\ \text { Rows } & t-1 & 3 \\ \text { Cols } & t-1 & 3 \\ \text { Treatments } & t-1 & 3 \\ \text { Error } & (t-1)(t-2) & 6 \\ \text { Total } & \left(t^{2}-1\right) & 15\end{array}$
