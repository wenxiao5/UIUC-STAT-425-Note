...
\begin{example}
If the confidence coefficents are $95\%$ for all $\mu_i$, the confidence coefficient will be $(95\%)^n<95\%$ for family $f(\mu_1,...,\mu_n)$. So the confidence interval will be \textbf{wider} than individual.
\end{example}
