...
$$\text{i.e. }\mathbb{E}(\mathbf{A}\mathbf{Z})=\mathbf{A}\mu;\ Var(\mathbf{A}\mathbf{Z})=\mathbf{A}Var(\mathbf{Z})\mathbf{A}^T$$

(3)$$Var(\mathbf{A}\mathbf{Z})=\mathbb{E}[(\mathbf{A}\mathbf{Z}-\mathbf{A}\mu)^T(\mathbf{A}\mathbf{Z}-\mathbf{A}\mu)]=\mathbf{A}\mathbb{E}[(\mathbf{Z}-\mu)(\mathbf{A}\mathbf{Z}-\mathbf{A}\mu)]$$
