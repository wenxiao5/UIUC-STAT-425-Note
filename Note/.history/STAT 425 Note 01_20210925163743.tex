...
$$
$0 \leq R^{2} \leq 1$
$$nR^2=\sum_{i}\frac{(\hat{y}_i-\bar{y})^2}{S_y^2}$$
...
\subsubsection{Check Constancy of Variance(Homoscedasticity): graph \textit{residuals} against \textit{Fitted Values} $\hat{y}$}
SLR:
\begin{center}\begin{figure}[htbp]
    \centering
...
\subsubsection{Check Constancy of Variance(Homoscedasticity): Breusch-Pagan Test}


\subsubsection{Check Normality: graph $residuals$ against its frequency}
\begin{center}\begin{figure}[htbp]
    \centering
