...
Then we can compute the \textbf{Maximum likelihood estimators}: obviously, maximizing $L(\beta_0,\beta_1,\sigma^2)$ is as same as minimizing $\sum_{i=1}^n(y_i-(\beta_0+\beta_1x_i))^2$
