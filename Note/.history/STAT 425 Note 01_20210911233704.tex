...
$$
where $R R S_{0}=$ Residual sum of squares for the model under $H_{0} ; R R S_{a}=$ Residual sum of squares for the model under $H_{\alpha}$
...
Reject $H_{0}$, if $F$ test statistic is large, that is, the variation missed by the reduced model, when being compared with the error variance, is significantly large.
