...
\subsubsection{Check Homoscedasticity: graph $residuals$ against $\hat{y}$}
\begin{center}\begin{figure}[htbp]
    \centering
...
\begin{center}\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.5]{check3.png}
    \caption{}
    \label{}
\end{figure}\end{center}
If violates No-Autocorrelation: Transform \textit{dependent variable}: $\ln{y}, \frac{1}{y},y^2,\sqrt{y}$
