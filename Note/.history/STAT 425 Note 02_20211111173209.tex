...
\begin{equation}
    \begin{aligned}
        SS(|A,B,AB)
        SS(A|B,AB)=S(A,B,AB)-S(B,AB)&=2.1340\\
        SS(B|A,AB)=S(A,B,AB)-S(A,AB)&=11.7375\\
        SS(AB|A,B)=S(A,B,AB)-S(A,B)&=1.9800\\
        \Rightarrow	3(SSA+SSB+SSAB+SSR)&=2.1340+11.7375+1.9800+7.9151\\
