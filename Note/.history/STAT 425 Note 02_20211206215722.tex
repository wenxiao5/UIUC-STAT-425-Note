...
For balanced data, REML and ANOVA estimation tend to coincide.\begin{center}\begin{figure}[hb]
    \centering
    \includegraphics[scale=0.5]{REML.png}
    \caption{}
    \label{}
\end{figure}\end{center}
\begin{center}\begin{figure}[hb]
    \centering
    \includegraphics[scale=0.5]{REML2.png}
    \caption{}
    \label{}
\end{figure}\end{center}
