...
\subsection{}
$$\underbrace{\bar{y}_{i j} \cdot-\bar{y} \ldots}_{\begin{array}{c}\text { Deviation of estimated } \\ \text { treatment mean around } \\ \text { overall mean }\end{array}}=\underbrace{\bar{y}_{i . .}-\bar{y} \ldots}_{\begin{array}{c}\text { A main } \\ \text { effect }\end{array}}+\underbrace{\bar{y} \cdot j \cdot-\bar{y} \ldots}_{\begin{array}{c}\text { B main } \\ \text { effect }\end{array}}+\underbrace{\bar{y}_{i j} \cdot-\bar{y}_{i . .}-\bar{y} \cdot j \cdot+\bar{y} \ldots}_{\begin{array}{c}\text { A B interaction } \\ \text { effect }\end{array}}$$
$$
