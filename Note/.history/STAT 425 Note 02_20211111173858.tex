...
\begin{equation}
    \begin{aligned}
        SS(intercept|A,B,AB)=SST-S(A,B,AB)&=15.0605\\
        SS(A|intercept,B,AB)=SST-S(intercept,B,AB)&=2.1340\\
        SS(B|intercept,A,AB)=SST-S(intercept,A,AB)&=11.7375\\
        SS(AB|intercept,A,B)=SST-S(intercept,A,B)&=1.9800\\
        \Rightarrow	SST&=15.0605+2.1340+11.7375+1.9800\\
        TSS=SSA+SSB+SSAB+SSR&=7.9222
    \end{aligned}
    \nonumber
\end{equation}
