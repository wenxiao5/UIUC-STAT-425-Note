...
Note that $\kappa$ is \textit{not scale-invariant}, so we should \textit{standardized} each column of X (i.e. each column should have zero mean and sample variance equal to 1, before calculating the condition number).
